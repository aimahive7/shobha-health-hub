...
const features = [
  ...
  'Same-day delivery within Pimpri area',
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Your trusted pharmacy in Pimpri since {ESTABLISHED_YEAR}. With {yearsOfService} years of dedicated service,
              we've been committed to providing genuine medicines, cosmetics, and healthcare products to our community.
            </p>

            <p className="text-muted-foreground leading-relaxed">
              At {STORE_NAME}, we believe in making healthcare accessible and convenient. Our WhatsApp ordering
              system allows you to get your medicines delivered to your doorstep with just a message. We maintain
              the highest standards of quality and authenticity in every product we sell.
            </p>
